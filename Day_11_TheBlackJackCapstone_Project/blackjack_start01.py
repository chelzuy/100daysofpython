...
#11 is the Ace.
from blackjack_final import play_game
import random
from replit import clear
from art import logo

def deal_card():
    "Function that will return random card from the deck"
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
def calculate_score(cards):
    """Function that will calculate the user score and computer score"""
...
def compare(user_score, computer_score):
    """"Function that will compare the user_score vs computer_score"""
    if user_score > 21 and computer_score > 21:
        ...
        return "Your cards are over 21. You lose"
    elif computer_score > 21:
        return "Computer's cards are over 21. You win"
    elif user_score > computer_score:
        return "You win"
    else:
        return "You lose"
...
def play_game():
    """ Function that will generate the game. """
