...
def deal_card():
    """
    This function will return random card from the deck.
    """
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
def calculate_score(cards):
    """ This will calculate the total score of the user and computer's cards """
...
def compare(user_score, computer_score):
    """
    This function will compare the user_score vs computer_score
    """
...
#If they answer yes, clear the console and start a new game of blackjack and 
